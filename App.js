...
const BACKEND_ENDPOINT = 'https://fifty-salvage-starring.ngrok-free.dev/api/v1/sos/trigger';
...
// Pure JS mobile-safe Base64 implementation (Bypasses missing browser btoa)
...
async function executeEmergencyDispatch(isDuressMode = false) {
  try {
    ...
    // Obfuscate for logging or custom header validation
